    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return StoreFeatureSearchPage(storeId: storeId);
        },
      ),
      GoRoute(
      ...
      GoRoute(
        path: '/stores/:storeId/inventory/exports',
        name: RouteNames.storeInventoryExport,
        builder: (context, state) {
          final storeId = int.tryParse(state.pathParameters['storeId'] ?? '');
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return StoreInventoryExportProductsPage(
            storeId: storeId,
            seedData: seedData,
          );
        },
      ...
      GoRoute(
        path: '/stores/:storeId/inventory/exports/draft',
        name: RouteNames.storeInventoryExportDraft,
        builder: (context, state) {
          final storeId = int.tryParse(state.pathParameters['storeId'] ?? '');
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          return VoiceOrderPage(storeId: storeId);
        },
      ),
      GoRoute(
